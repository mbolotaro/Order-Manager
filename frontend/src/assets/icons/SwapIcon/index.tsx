...
export default function SwapIcon(props: IBaseIconProps) {
    ...
    return <svg width={props.size} height={props.size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-labelledby="swapVerticalIconTitle" stroke={color} stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color={color}> 
